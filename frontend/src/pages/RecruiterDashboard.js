...
function RecruiterDashboard() {
  return (
    ...
    >
      <Row className="w-80 bg-light rounded-3 shadow-lg">
            ...
            <Row className="p-5">
                ...
                <Card className="h-100 shadow mx-3">
                  <Card.Body className="d-flex align-items-center justify-content-between px-4 py-3">
                    <div className="d-flex align-items-center">
                      <FaClipboardCheck className="me-3 text-primary display-5" />
                      <div>
                        <h5 className="mb-0">Job postings:</h5>
                        <span className="fw-bold fs-5">10</span>
                      </div>
                    </div>
              ...
              <Col md={6} className="p-0">
                <Card className="h-100 shadow mx-3">
                  <Card.Body className="d-flex align-items-center justify-content-between px-4 py-3">
                    <div className="d-flex align-items-center">
                      <FaUser className="me-3 text-primary display-5" />
                      <div>
